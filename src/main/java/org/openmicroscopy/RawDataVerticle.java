...
public class RawDataVerticle implements Verticle {
    ...
    public RawDataVerticle(DataSource dataSource) {
    ...
    public void start(Future<Void> future) throws SQLException {
        ...
        new RequestHandlerForRaw(connection).handleFor(router, "/raw/:imageid");
